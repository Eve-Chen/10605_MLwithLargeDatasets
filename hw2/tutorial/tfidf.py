...
class TFIDF(Planner):
    ...
    udocvec3 = Augment(udocvec2, sideviews=[docFreq, ndoc], loadedBy=lambda v1, v2: (GPig.rowsOf(v1), GPig.onlyRowOf(v2)))
    trial = Map(udocvec3, by=func)
